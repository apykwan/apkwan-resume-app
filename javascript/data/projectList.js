export const projectList = [
    ...
    }, 
    {
        ...
        highlights: ['React.js', 'Redux Saga', 'Node.js', 'MongoDB', 'SASS', 'Gmail login', 'Firebase database', 'Stripe credit card payment'],
    ...
    }, 
    {
        ...
        link: 'https://apkwan-places.firebaseapp.com',
        highlights: ['React.js', 'Node.js', 'MongoDB', 'Bootstrap', 'Restful APIs', 'Authentication', 'Pictures upload (Cloudinary)'],
        description: 'Do you have any favorite places to share with us? Here is the place!'
    },
    {
        name: 'Hotel Booking Business',
        icon: 'fa-solid fa-hotel',
        link: 'https://apkwan-hotel.firebaseapp.com',
        highlights: ['React.js', 'Node.js', 'MongoDB', 'Bootstrap', 'Restful APIs', 'Authentication', 'Stripe credit card payment'],
        description: 'This hotel website bridges the gap between support agents agents and customers. The website will take a whopping 20% cut of each transection.'
    },
    {
    ...
    }, 
    {
        ...
        link: 'https://apkwan-realtor-grid.firebaseapp.com',
        highlights: ['CSS Grid', 'SASS'],
        description: 'Making a responsive website with CSS grid and SASS.'
    }, 
    {
        name: 'Pong from the 70s',
